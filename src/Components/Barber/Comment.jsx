      ...
      <div className='flex items-center justify-center'>
        <div className='bg-orange-50 rounded-2xl px-10 py-8 shadow-lg hover:shadow-black transition duration-500'>
          ...
          <div className='mt-4'>
            ...
            <p className='mt-4 text-md text-gray-600'>Idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness.</p>
            <div className='flex justify-between items-center'>
              <div className='mt-4 flex items-center space-x-4 py-6'>
                <div>
                  <img className='w-20 h-12 border-2 border-black rounded-full' src='https://images.unsplash.com/photo-1593104547489-5cfb3839a3b5?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1036&q=80' alt='' />
                </div>
