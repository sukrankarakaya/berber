...
const HomePageCard = () => {
  return (
    <div className="flex flex-col gap-8 py-28 min-h-screen bg-light items-center    ">
      ...
      <div className="felx justify-center items-center max-sm:pl-0  ">
        <div className="flex flex-row gap-12 max-sm:pl-3  ">
          <div className="flex flex-col gap-4 w-full">
            <label htmlFor="" className="text-2xl max-sm:text-xl">
              En Yakın Berber Dükkanları
            </label>
            <BarberCard />
          </div>
        </div>
        <div className="flex flex-col gap-8 items-start w-full py-8  max-sm:hidden ">
          <div className="flex flex-col gap-4 w-full">
